...
const {resolveComponent:_resolveComponent,createVNode:_createVNode,withCtx:_withCtx,createTextVNode:_createTextVNode,openBlock:_openBlock,createBlock:_createBlock,createCommentVNode:_createCommentVNode} = await importShared('vue');
...
const _sfc_main = {
  ...
  emits: ['saved', 'message', 'submit', 'close'],
...
const SettingsPanel = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-657ad083"]]);
