...
"./Page":()=>{
      ...
      return __federation_import('./__federation_expose_Page-eqJRuvtT.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},
"./Config":()=>{
...
"./AppPage":()=>{
      ...
      return __federation_import('./__federation_expose_AppPage--J_zjv3u.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
