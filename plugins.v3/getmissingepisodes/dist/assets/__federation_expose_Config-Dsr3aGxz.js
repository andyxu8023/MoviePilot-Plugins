...
import { _ as _export_sfc, S as SettingsPanel, u as unwrapResponse } from './SettingsPanel-C6XfKivv.js';
...
return (_ctx, _cache) => {
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
    _createElementVNode("div", _hoisted_2, [
      _cache[3] || (_cache[3] = _createElementVNode("div", { class: "text-subtitle-1" }, [
    ...
    (loading.value)
      ...
      : (_openBlock(), _createBlock(SettingsPanel, {
          ...
          onMessage: _cache[1] || (_cache[1] = payload => { message.value = payload.text; messageType.value = payload.color === 'error' ? 'error' : 'success'; }),
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-e93ea44c"]]);
